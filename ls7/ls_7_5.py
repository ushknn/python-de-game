...
btn = tkinter.Button(text="診断する", font=("Times New Roman",21), bg="lightgreen", command=click_btn)
btn.place(x=400, y=480)
text = tkinter.Text(width=36, height=3, font=("Time new Roman", 16))
